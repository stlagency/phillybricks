...
- **Vercel Pro** project + env — at M4. **Supabase Storage** bucket + S3 access keys — at M4. **Stripe** + **Resend** keys — at M7. **healthchecks.io** URL — anytime.
